    ...
    namespace
    {
        ...
        const std::unordered_map<std::string, std::string>& DefaultLabels()
        {
            static const std::unordered_map<std::string, std::string> labels{
                ...
                { "ambientWithinGauge", "Ambient Brightness Within Weather Gauge" },
                { "ambientBetweenGauge", "Ambient Brightness Between Weather Gauge" },
                { "sunlightWithinGauge", "Sunlight Brightness Within Weather Gauge" },
                { "sunlightBetweenGauge", "Sunlight Brightness Between Weather Gauge" },
                { "darkLimit", "Dark" },
                { "brightLimit", "Bright" },
                { "notAvailable", "N/A" },
