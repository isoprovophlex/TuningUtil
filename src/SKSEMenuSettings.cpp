    ...
    namespace
    {
        ...
        const std::unordered_map<std::string, std::string>& DefaultStatusMessages()
        {
            static const std::unordered_map<std::string, std::string> messages{
                ...
                { "presetDefaultPreview", "Previewing the default settings for {category}." },
                { "presetLoadFailure", "The preset could not be loaded. Check the TuningUtil log for details." },
                { "presetStaged", "Created preset {preset} in category {category} for this session. Select Save Presets to keep it." },
                { "presetStageFailure", "The preset could not be created. Check the TuningUtil log for details." },
                { "presetRenamed", "Renamed preset {preset} to {newPreset} in category {category}." },
                { "presetRenameFailure", "The preset could not be renamed. Check the TuningUtil log for details." },
                { "presetCategoryRenamed", "Renamed category {category} to {newCategory}." },
                { "presetCategoryRenameFailure", "The preset category could not be renamed. Check the TuningUtil log for details." },
                { "presetUpdated", "Updated preset {preset} in category {category} with the current settings." },
                { "presetUpdateFailure", "The preset could not be updated. Check the TuningUtil log for details." },
                { "presetMoved", "Preset order updated." },
                { "presetMoveFailure", "The preset order could not be updated. Check the TuningUtil log for details." },
                ...
                { "weatherSetupRestored", "Saved Weather Setup restored." },
                { "weatherSetupRestoreFailure", "Weather Setup could not be restored: {reason}" },
                { "lightingSetupSaved", "Lighting Setup saved to profileSettings.json." },
                { "lightingSetupSaveFailure", "Lighting Setup could not be saved: {reason}" },
                { "lightingSetupRestored", "Saved Lighting Setup restored." },
                { "lightingSetupRestoreFailure", "Lighting Setup could not be restored: {reason}" },
                ...
                { "profilePluginGatingSaved", "Plugin gating saved. Restart Skyrim to apply it." },
                { "profilePluginGatingRestored", "Unsaved plugin gating changes restored." },
                { "profilePluginGatingSaveFailure", "Plugin gating could not be saved: {reason}" },
                { "ambientAnchorWeatherSaved", "Ambient anchor weather saved. Restart Skyrim to apply it." },
                { "ambientAnchorWeatherRestored", "Unsaved ambient anchor weather change restored." },
                { "ambientAnchorWeatherSaveFailure", "Ambient anchor weather could not be saved: {reason}" },
                ...
                { "userSettingsPromoted", "Saved the current {profile} settings as defaults in profileSettings.json." },
                { "userSettingsPromoteFailure", "Current settings could not be saved as defaults: {reason}" },
                ...
                { "layoutEditSessionFailure", "Dev Mode could not create its temporary working layout. Check the TuningUtil log for details." },
                ...
                { "layoutModuleRenamed", "Module renamed." },
            };
            return messages;
        }
        ...
        const std::unordered_map<std::string, std::string>& DefaultDisplayMessages()
        {
            static const std::unordered_map<std::string, std::string> messages{
                ...
                { "selectPresetSettings", "Select a preset to view its settings." },
                { "presetSettingsLoadFailure", "The selected preset settings could not be read." },
                { "noPresetSettings", "This preset does not modify any settings." },
                ...
                { "noLocationTypes", "No location types added" },
                { "noMultiLocationExceptions", "No multi-location exceptions added" },
                { "profilePluginDependenciesDescription", "Enable this profile when this list is empty or any listed plugin is loaded." },
                { "profileDisabledProfilesDescription", "Disable the listed profiles while this profile's plugin dependency is met and this profile is enabled." },
                { "profilePluginGatingLoadFailure", "Plugin gating could not be loaded: {reason}" },
                { "noDisabledProfiles", "No profiles disabled" },
                { "ambientAnchorWeatherDescription", "Select the weather whose baseline Day Z- sets the between-weather ambient anchor. The original EditorID is saved." },
                { "ambientAnchorWeatherLoadFailure", "Ambient anchor weather could not be loaded: {reason}" },
                ...
                { "sliderCreatorFilteredLightingUnsupportedSetting", "Lighting Template filters support only Lighting brightness and Fog Strength settings." },
                ...
                { "sliderCreatorPageAdvancedFailure", "The page visibility could not be changed." },
                ...
                { "layoutModuleUnavailable", "The selected module is unavailable." },
                { "layoutModuleNameUnavailable", "This module does not have a display name." },
                { "layoutModuleRenameFailure", "The module could not be renamed." },
                ...
                { "promoteUserSettingsConfirmation", "This saves the profile's current user overrides as defaults in profileSettings.json and removes its userSettings.json. TuningUtil cannot undo this operation. Continue?" },
            };
            return messages;
        }
        ...
        const std::unordered_map<std::string, std::string>& DefaultLabels()
        {
            static const std::unordered_map<std::string, std::string> labels{
                ...
                { "saveAll", "Save All Pages" },
                { "restoreAll", "Restore All Pages" },
                { "resetAll", "Reset All Pages to Default" },
                { "savePresetSelection", "Save Preset Selection" },
                { "presetControl", "Preset Creator" },
                { "sliderCreator", "Slider Creator" },
                { "weatherSetup", "Weather Setup" },
                { "lightingSetup", "Lighting Setup" },
                { "saveWeatherSetup", "Save Weather Setup" },
                { "restoreWeatherSetup", "Restore Weather Setup" },
                { "saveLightingSetup", "Save Lighting Setup" },
                { "restoreLightingSetup", "Restore Lighting Setup" },
                { "createPresetHeader", "Create Preset" },
                { "savePresetControl", "Save Presets" },
                { "restorePresetControl", "Restore Presets" },
                { "createPreset", "Create Preset" },
                { "editPresetHeader", "Edit Preset" },
                ...
                { "applyProfilePriority", "Apply Profile Priority" },
                { "enableProfile", "Enable Profile" },
                { "advanced", "Advanced" },
                { "defaultOpen", "Open by default" },
                { "profilePluginGating", "Plugin Gating" },
                { "savePluginGating", "Save Plugin Gating" },
                { "restorePluginGating", "Restore Plugin Gating" },
                { "profileName", "Profile" },
                { "addOrUpdateProfile", "Add / Update Profile" },
                { "clearProfiles", "Clear Profiles" },
                { "disabledProfiles", "Disabled Profiles" },
                { "removeProfile", "Remove Profile" },
                { "ambientAnchorWeather", "Ambient Anchor" },
                { "ambientAnchorWeatherSelection", "Weather" },
                { "applyAmbientAnchorWeather", "Apply Ambient Anchor Weather" },
                { "restoreAmbientAnchorWeather", "Restore Ambient Anchor Weather" },
                { "advancedPage", "Page is Advanced" },
                { "advancedModule", "Module is Advanced" },
                { "savePageEdits", "Save Page Edits" },
                { "restorePageEdits", "Restore Page Edits" },
                { "saveAllPageEdits", "Save All Page Edits" },
                { "restoreAllPageEdits", "Restore All Page Edits" },
                ...
                { "lightingTemplateFilter", "Template Filter" },
                { "locationType", "Location Type" },
                { "addOrUpdateLocationType", "Add / Update Location Type" },
                { "clearLocationTypes", "Clear Location Types" },
                { "locationTypes", "Location Types" },
                { "removeLocationType", "Remove Location Type" },
                { "multiLocationException", "Multi-Location Exception" },
                { "addOrUpdateMultiLocationException", "Add / Update Multi-Location Exception" },
                { "clearMultiLocationExceptions", "Clear Multi-Location Exceptions" },
                { "multiLocationExceptions", "Multi-Location Exceptions" },
                { "removeMultiLocationException", "Remove Multi-Location Exception" },
                { "baseLightFilter", "Base Light Filter" },
                ...
                { "sliderCreatorFilteredBaseLight", "Filtered Base Light Slider" },
                { "saturationScales", "Saturation Scales" },
                { "weatherLinks", "Links" },
                { "hueRanges", "Hue Ranges" },
                { "compressionAnchor", "Compression Anchor" },
                { "anchor", "Anchor" },
                { "ambientWithinGauge", "Weather Ambient Within Gauge" },
                { "ambientBetweenGauge", "Weather Ambient Between Gauge" },
                { "sunlightWithinGauge", "Weather Sunlight Within Gauge" },
                { "sunlightBetweenGauge", "Weather Sunlight Between Gauge" },
                { "darkLimit", "Dark" },
                { "brightLimit", "Bright" },
                { "notAvailable", "N/A" },
                ...
                { "interiorAmbientLinks", "Ambient Links" },
                { "templateInheritance", "Template Inheritance" },
                { "templateInheritAmbientColor", "Ambient Color" },
                { "templateInheritDirectionalColor", "Directional Color" },
                { "templateInheritFogColor", "Fog Color" },
                { "templateInheritFogNear", "Fog Near" },
                { "templateInheritFogFar", "Fog Far" },
                { "templateInheritDirectionalRotation", "Directional Rotation" },
                { "templateInheritDirectionalFade", "Directional Fade" },
                { "templateInheritClipDistance", "Clip Distance" },
                { "templateInheritFogPower", "Fog Power" },
                { "templateInheritFogMax", "Fog Maximum" },
                { "templateInheritLightFadeDistances", "Light Fade Distances" },
                { "cell", "Cell" },
                { "addExcludedCell", "Add Excluded Cell" },
                { "excludedCells", "Excluded Cells" },
                { "interiorSaturationScales", "Saturation Scales" },
                { "lightingBulbSaturationScales", "Bulb Saturation Scales" },
                { "interiorLightingHueRanges", "Ambient & Bulb Hue Ranges" },
                ...
                { "saveCurrentSettingsAsDefault", "Save Current Settings as Default" },
                { "saveCurrentSettingsAsDefaultTitle", "Save Current Settings as Default?" },
                { "confirmSaveCurrentSettingsAsDefault", "Save as Default" },
                { "cancelSaveCurrentSettingsAsDefault", "Cancel" },
