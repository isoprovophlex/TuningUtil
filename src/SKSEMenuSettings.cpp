...
namespace MPL::SKSEMenuSettings
{
    namespace
    {
        ...
        struct ButtonColors
        {
            std::optional<Color> ordinary = Color{ 77.0f, 77.0f, 77.0f, 1.0f };
            std::optional<Color> save = Color{ 43.0f, 93.0f, 157.0f, 1.0f };
            std::optional<Color> restore = Color{ 102.0f, 102.0f, 102.0f, 1.0f };
            std::optional<Color> reset = Color{ 120.0f, 40.0f, 40.0f, 1.0f };
            std::optional<Color> destructive = Color{ 120.0f, 40.0f, 40.0f, 1.0f };
        };

        struct PresetColors
        {
            Color active{ 43.0f, 93.0f, 157.0f, 1.0f };
            Color activeHovered{ 68.0f, 112.0f, 169.0f, 1.0f };
            Color activePressed{ 117.0f, 150.0f, 191.0f, 1.0f };
        ...
        const std::unordered_map<std::string, std::string>& DefaultStatusMessages()
        {
            static const std::unordered_map<std::string, std::string> messages{
                ...
                { "presetControlRestoreFailure", "Preset changes could not be restored. Check the TuningUtil log for details." },
                ...
                { "presetStaged", "Created preset {preset} in category {category} for this session. Select Save Page Edits to keep it." },
                ...
                { "presetRemovalStaged", "{preset} in {category} will be removed when Save Page Edits is selected." },
                { "presetCategoryRemovalStaged", "The {category} category will be removed when Save Page Edits is selected." },
                ...
                { "layoutModuleUpdated", "Element or module updated." },
            };
            return messages;
        }
        ...
        const std::unordered_map<std::string, std::string>& DefaultDisplayMessages()
        {
            static const std::unordered_map<std::string, std::string> messages{
                ...
                { "ambientAnchorWeatherLoadFailure", "Compression anchor weather could not be loaded: {reason}" },
        ...
        const std::unordered_map<std::string, std::string>& DefaultLabels()
        {
            static const std::unordered_map<std::string, std::string> labels{
                ...
                { "ambientAnchorWeather", "Compression Anchor" },
                ...
                { "includedHues", "Included Hues" },
                { "baseLight", "Base Light" },
                { "baseObjectFilter", "Base Object Filter" },
                { "xemiFilter", "XEMI Filter" },
                { "enableXemiFilter", "Enable XEMI Filter" },
                ...
                { "lightingAmbientLinks", "Ambient Links" },
                ...
                { "sliderCreatorOverrideProfileLinks", "Override Profile Links" },
                ...
                { "addModule", "Modules" },
                { "module", "Module" },
                { "addSelectedModule", "Add Module" },
                { "addElement", "Elements" },
                { "element", "Element" },
                { "elementText", "Text" },
                { "addSelectedElement", "Add Element" },
